    ...
    <div class="app-container">
        ...
        <div class="sidebar">
            <div class="logo-container">
                <div class="logo">
                    <img src="assets/images/sonatel-logo.png" alt="Sonatel Academy">
                    <div class="logo-text">
                        <span>Orange Digital Center</span>
                        <span class="subtitle">sonatel</span>
                    </div>
                </div>
            ...
            <header class="top-header">
                ...
                <div class="user-menu">
                    ...
                    <div class="user-profile">
                        <div class="user-info">
                            <span class="user-name"><?= isset($user) ? $user['name'] : 'Utilisateur' ?></span>
                            <span class="user-role"><?= isset($user) ? $user['profile'] : 'Admin' ?></span>
                        </div>
                        <div class="avatar">
